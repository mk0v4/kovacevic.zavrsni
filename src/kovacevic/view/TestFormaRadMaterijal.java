 ...
 */
public class TestFormaRadMaterijal extends javax.swing.JPanel {
    ...
    /**
     * Creates new form TestFormaRadMaterijal
     */
    public TestFormaRadMaterijal() {
        ...
        tblRad = new WrappableTable(tblRad, tblRad.getModel(), jScrollPaneRad);
    ...
    protected void dpoRad() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(jtpRadMaterijal, (nfePoruka.trim().equals("") ? "" : nfePoruka + "\n") + pi.getOpis() + pi.getGreska(),
                    dodatakNaslovu, HEIGHT);
...
//            TODO provjeriti ispis nfePoruka
            JOptionPane.showMessageDialog(jtpRadMaterijal, (nfePoruke.isEmpty() ? "" : nfePoruke.toString() + "\n") + pi.getOpis() + pi.getGreska(),
                    dodatakNaslovu, HEIGHT);
    ...
    private void traziRad() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(jtpRadMaterijal, "Unešena vrijednost nije broj", " - Traži", HEIGHT);
    ...
    private void initComponents() {
        ...
        jPanelRadLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelRadLayout.createSequentialGroup()
                ...
                .addGroup(jPanelRadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelRadLayout.createSequentialGroup()
                        .addGroup(jPanelRadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cmbGrupeRadova, 0, 125, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanelRadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtRadTraziCijena, javax.swing.GroupLayout.DEFAULT_SIZE, 119, Short.MAX_VALUE))
            ...
            .addGroup(jPanelMaterijalLayout.createSequentialGroup()
                ...
                .addGroup(jPanelMaterijalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelMaterijalLayout.createSequentialGroup()
                        .addGroup(jPanelMaterijalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanelMaterijalLayout.createSequentialGroup()
                                .addComponent(cmbGrupeMaterijala, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
                            .addGroup(jPanelMaterijalLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelMaterijalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanelMaterijalLayout.createSequentialGroup()
                                .addComponent(txtMaterijalTraziProizvodac, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
                            .addGroup(jPanelMaterijalLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelMaterijalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanelMaterijalLayout.createSequentialGroup()
                                .addComponent(txtMaterijalTraziOznaka, javax.swing.GroupLayout.DEFAULT_SIZE, 113, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jtpRadMaterijal, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 460, Short.MAX_VALUE)
        );
    ...
    private void btnRadPromjeniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRadPromjeniActionPerformed
        ...
        if (rad == null || tblRad.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(jtpRadMaterijal, "Odaberite stavku vidljivu unutar tablice",
                    " - Promjena postojećeg", HEIGHT);
        } else {
    ...
    private void btnRadObrisiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRadObrisiActionPerformed
        obrisi = true;
        if (rad == null || tblRad.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(jtpRadMaterijal, "Odaberite stavku vidljivu unutar tablice", " - Obriši", HEIGHT);
        } else {
            int i = tblRad.getSelectedRow();
            DefaultTableModel model = (DefaultTableModel) tblRad.getModel();

            Object[] options = {"Da", "Ne"};
            int reply = JOptionPane.showOptionDialog(jtpRadMaterijal, "Sigurno želite obrisati stavku? \n"
    ...
    private void btnRadUputeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRadUputeActionPerformed
        JOptionPane.showMessageDialog(jtpRadMaterijal,
                "Pretraživanje:" + "\n"
                ...
                " - Upute za korištenje", JOptionPane.PLAIN_MESSAGE);
