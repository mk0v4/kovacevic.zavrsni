 ...
 */
public class TestFormaAnalizaCijene extends javax.swing.JPanel {
...
//    iz liste u obradu i save
    ...
    /**
     * Creates new form TestFormaAnalizaCijene
     */
    public TestFormaAnalizaCijene() {
...
//        popupMenuJTable();
        ...
        dodajGrupacijaNorme.addActionListener((ActionEvent e) -> {
            ...
            if (jTreeNorma.getSelectionPath() != null) {
                DefaultMutableTreeNode leaf = (DefaultMutableTreeNode) jTreeNorma.getLastSelectedPathComponent();
                if (!leaf.isLeaf()) {
                    return;
                }
                FormaGrupacijaNorme grupacijaNorme1 = new FormaGrupacijaNorme(this.grupacijaNorme, true, true);
                ...
                grupacijaNorme1.addWindowListener(new WindowAdapter() {
                    ...
                    public void windowClosing(WindowEvent arg0) {
                        ...
                        grupacijaNorme1.setVisible(false);
                    }
                });
            }
            ...
            if (jTreeNorma.getSelectionPath() != null) {
                ...
                grupacijaNorme.addWindowListener(new WindowAdapter() {
                    ...
                    public void windowClosing(WindowEvent arg0) {
                        ...
                        jTreeNorma.setSelectionRow(red);
//  spremanje
                        grupacijaNorme.setVisible(false);
                    }
                });
            }
...
//        dpoAnalizaRad(rezultatiAnalizaRad);
        ...
        try {
            ...
            JOptionPane.showMessageDialog(jFrameEditAnalizaCijene, (nfePoruka.trim().equals("") ? "" : nfePoruka + "\n") + pi.getOpis() + pi.getGreska(),
...
//        System.out.println("zbrojenNormativVremena.toString() " + zbrojenNormativVremena.toString());
    ...
    private void popunjavanjeTabliceGrupeRada(JTable tablica) {
        ...
        ArrayList<TestFormaAnalizaCijene.GrupaRadova> listaGrupeRadova = new ArrayList<>();
        if (analizaCijene != null) {
            for (AnalizaRad analizaRad : rezultatiAnalizaRad) {
                boolean imaDuplikat = false;
                if (listaGrupeRadova.size() > 0) {
                    TestFormaAnalizaCijene.GrupaRadova grupaRad = new TestFormaAnalizaCijene.GrupaRadova();
                    ...
                    int i = 0;
                    for (TestFormaAnalizaCijene.GrupaRadova grupaRadova : listaGrupeRadova) {
        ...
        for (int i = 0; i < root.getChildCount(); i++) {
            ...
            for (GrupacijaNorme grupacijaNorme : grupacijaNormeLista) {
                if (matchingCharactes(childAt.toString(), grupacijaNorme.getOznakaNorme(), 6)) {
                    node2 = new TestFormaAnalizaCijene.NameOfJTreeNode(grupacijaNorme.getOznakaNorme() + " " + grupacijaNorme
                            .getOpis(),
                            grupacijaNorme);
                    childAt.add(node2);
                }
...
//        System.out.println(matchingPart);
    ...
    private void initComponents() {
        ...
        jPanelNormaLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelNormaLayout.createSequentialGroup()
                ...
                .addGroup(jPanelNormaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jScrollPaneTableNorma, javax.swing.GroupLayout.DEFAULT_SIZE, 763, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanelNormaLayout.setVerticalGroup(
            ...
            .addGroup(jPanelNormaLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jScrollPaneTableNorma, javax.swing.GroupLayout.DEFAULT_SIZE, 320, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void btnObrisiOperacijuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnObrisiOperacijuActionPerformed
        ...
        System.out.println("rezultatiAnalizaRad.size() " + rezultatiAnalizaRad.size());
        DefaultTableModel model = (DefaultTableModel) tblOperacije.getModel();
    ...
    private void btnPromjeniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPromjeniActionPerformed
        ...
        if (analizaCijene == null || jTableNorma.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(jFrameEditAnalizaCijene, "Odaberite stavku vidljivu unutar tablice",
